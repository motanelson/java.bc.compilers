...
public class bcParserApp {
    ...
    public static void main(String[] args) {
        ...
        // ==========================
        if (args.length == 0) {
            System.out.println("Uso: java bcParserApp <ficheiro.bc>");
            return;
        }
        ...
        try {
            ...
            bcLexer lexer = new bcLexer(charStream);
            ...
            for (Token token : tokens.getTokens()) {
                String name = bcLexer.VOCABULARY.getSymbolicName(token.getType());
